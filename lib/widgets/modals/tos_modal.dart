...
import 'package:myfriendfaith/utils/tos.dart';

@RoutePage()
class TosModal extends StatefulWidget {
  const TosModal({Key? key}) : super(key: key);

  @override
  _TosModalState createState() => _TosModalState();
}

class _TosModalState extends State<TosModal> {
  bool _isMenuOpen = false;
  Map<dynamic, dynamic> _menuItems = TOS.tos[0];
